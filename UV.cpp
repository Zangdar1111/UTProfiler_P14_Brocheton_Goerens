...
UV::UV(string c, string t, bool d) : Code(c), Titre(t), Tab_Categorie(new Categorie[1]),
    Credits_Categorie(new int[1]), Nb_Categorie(0), Tab_Cursus(new Cursus[1]), Nb_Cursus(0), DemiUV(d){}
